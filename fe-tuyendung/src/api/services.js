...
export const skillApi = {
  ...
  create: (skillName) => api.post('/skills', new URLSearchParams({ skillName })),
  update: (id, skillName) => api.put('/skills', new URLSearchParams({ id, skillName })),
  delete: (id) => api.delete(`/skills?id=${id}`),
};
